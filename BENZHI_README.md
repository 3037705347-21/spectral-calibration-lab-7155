# spectral-calibration-lab__003 Docker 交付说明
...
```bash
./build_benzhi_docker.sh spectral-calibration-lab__003-benzhi linux/amd64
docker run --rm -it spectral-calibration-lab__003-benzhi bash
```
