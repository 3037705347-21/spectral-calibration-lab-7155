...
func TestObservationRejectsBlankProfileAsBadRequest(t *testing.T) {
	server := New(lab.NewEngine())
	req := httptest.NewRequest(http.MethodPost, "/v1/observations", bytes.NewBufferString(`{"profile_id":"","values":[10,10.1,9.9]}`))
